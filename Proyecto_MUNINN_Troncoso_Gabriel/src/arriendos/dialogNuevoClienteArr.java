...
public class dialogNuevoClienteArr extends javax.swing.JDialog {
...
Icon iconoInfo  =  new ImageIcon("C:/Sistema Muninn/Imagenes/infoIcono.png"); 
     ...
     */
    public dialogNuevoClienteArr(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        btCancelarVent = new javax.swing.JButton();
        ...
        btCancelarVent.setBackground(new java.awt.Color(102, 100, 65));
        btCancelarVent.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        btCancelarVent.setForeground(new java.awt.Color(255, 255, 255));
        btCancelarVent.setText("Cancelar");
        btCancelarVent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCancelarVentActionPerformed(evt);
            }
        });
        getContentPane().add(btCancelarVent);
        btCancelarVent.setBounds(30, 460, 630, 40);
        ...
        btAddCliente.setBounds(30, 400, 630, 53);
    ...
    private void btCancelarVentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarVentActionPerformed
    ...
    }//GEN-LAST:event_btCancelarVentActionPerformed
    ...
    if(existerut.equals(""))
    {
        if(sqlcliente.validaRut(rut, digv))
        {
            if(validarCamposAddCl2())
            {
                ...
                JOptionPane.showMessageDialog(rootPane, "Cliente Agregado",  "Notificación", JOptionPane.PLAIN_MESSAGE, iconoBueno);
                this.dispose();
            }
...
InputMap map2 =  txtAddCliNomb.getInputMap( txtAddCliNomb.WHEN_FOCUSED);
      map2.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");        // TODO add your handling code here:
...
InputMap map2 =  txtComunClient.getInputMap( txtComunClient.WHEN_FOCUSED);
      map2.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");        // TODO add your handling code here:
...
InputMap map2 =  txtAddCliCiu.getInputMap( txtAddCliCiu.WHEN_FOCUSED);
      map2.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Event.CTRL_MASK), "null");        // TODO add your handling code here:
...
InputMap map2 =  txtAddCliEmail.getInputMap( txtAddCliEmail.WHEN_FOCUSED);
    ...
    private void txtAddCliCiuKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAddCliCiuKeyTyped
        if(txtAddCliCiu.getText().length()== 42) {
            evt.consume();
        }
...
txtComunClient.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogNuevoClienteArr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dialogNuevoClienteArr dialog = new dialogNuevoClienteArr(new javax.swing.JDialog(), true);
    ...
    private javax.swing.JButton btCancelarVent;
